...
const PROJECTS: Project[] = [
  {
    ...
    title: 'Parky',
    description:
      'Marketplace for parking management in Tenerife. Includes interactive maps, real-time availability, and a secure reservation system.',
  ...
  },
  {
    ...
    description:
      'Random maze generator implemented in C++, using search algorithms to create complex structures.',
    tech: ['C++'],
  ...
  },
  {
    ...
    title: 'Game of Life',
    description:
      'Implementation of Conway’s Game of Life in C++ using the SDL2 library for graphical rendering of the simulation.',
    tech: ['C++'],
  ...
  },
  {
    ...
    description:
      'Visualization of sorting algorithms (Bubble, Quick, Merge, etc.) to analyze their efficiency and real-time behavior.',
    tech: ['C++', 'SDL2'],
